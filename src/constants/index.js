export const projects = {
  ...
  categories: [
    { id: "all", label: "All" },
    { id: "work-spaces", label: "Branded Environment – Offices & Work Spaces" },
    { id: "retail", label: "Retail Experience & Visual Merchandising" },
    { id: "food-beverages", label: "F&B Spaces & Hospitality Branding" },
    { id: "sports-fitness", label: "Sports & Fitness Spaces" },
    { id: "lifestyle", label: "Home & Lifestyle Brands" },
    { id: "branding", label: "Product Branding & Packaging" },
    { id: "transformation", label: "Legacy & Transformation Projects" },
    { id: "real-estate", label: "Real Estate & Built Spaces" },
    { id: "campaign", label: "Campaign & Communication Design" },
